...
General utility scripts for data conversion and analysis.

## Scripts

-   `pickle_to_hdf5.py`: Converts old Pickle data files to HDF5 format.
-   `compress_pickle.py`: Compresses pickle files.
-   `estimate_cpu_time.py`: Estimates CPU time requirements for jobs.
