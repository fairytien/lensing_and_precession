...
### Code Files:
- `lensing_and_precession/modules/Classes.py`: Main production implementation (uses `odeint`)
- `lensing_and_precession/legacy/modules/Classes_v3.py`: Vectorized version (uses `cumulative_trapezoid`)
