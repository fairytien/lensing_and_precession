...
- `mcz_min`, `mcz_max`: Intended mcz grid bounds from Stage 1 compute settings (Msun)
- `mcz_pts`: Intended mcz grid size from Stage 1 compute settings
